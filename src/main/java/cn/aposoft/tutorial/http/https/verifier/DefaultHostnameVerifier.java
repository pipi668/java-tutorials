...
package cn.aposoft.tutorial.http.https.verifier;
...
public final class DefaultHostnameVerifier implements HostnameVerifier {
        ...
        if (subjectAlts != null && !subjectAlts.isEmpty()) {
            ...
            if (cn == null) {
                throw new SSLException(
                        "Certificate subject for <" + host + "> doesn't contain " + "a common name and does not have alternative names");
            }
    ...
    static void matchIPAddress(final String host, final List<SubjectName> subjectAlts) throws SSLException {
        ...
        throw new SSLPeerUnverifiedException(
                "Certificate for <" + host + "> doesn't match any " + "of the subject alternative names: " + subjectAlts);
    }
    ...
    private static boolean matchIdentity(final String host, final String identity, final PublicSuffixMatcher publicSuffixMatcher,
        ...
        if (asteriskIdx != -1) {
            ...
            // Additional sanity checks on content selected by wildcard can be
            // done here
            if (strict) {
