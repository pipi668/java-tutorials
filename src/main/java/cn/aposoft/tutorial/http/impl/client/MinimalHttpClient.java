 ...
 */
package cn.aposoft.tutorial.http.impl.client;
...
import cn.aposoft.tutorial.http.impl.execchain.MinimalClientExec;
...
public class MinimalHttpClient extends CloseableHttpClient {
    ...
    public MinimalHttpClient(final HttpClientConnectionManager connManager) {
        ...
        this.requestExecutor = new MinimalClientExec(new HttpRequestExecutor(), connManager, DefaultConnectionReuseStrategy.INSTANCE,
