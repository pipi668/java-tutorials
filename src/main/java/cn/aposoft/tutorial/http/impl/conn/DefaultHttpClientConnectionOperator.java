...
/**
 * Default implementation of {@link HttpClientConnectionOperator} used as
 * default in Http client, when no instance provided by user to
 * {@link BasicHttpClientConnectionManager} or
 * {@link PoolingHttpClientConnectionManager} constructor.
 *
 * @since 4.4
 */
...
public class DefaultHttpClientConnectionOperator implements HttpClientConnectionOperator {
    ...
    public void connect(final ManagedHttpClientConnection conn, final HttpHost host, final InetSocketAddress localAddress, final int connectTimeout,
        ...
        for (int i = 0; i < addresses.length; i++) {
            ...
            conn.bind(sock);
            // 查看 conn的具体实现
            this.log.debug(conn.getClass().getName());
