...
/**
 * Request executor that implements the most fundamental aspects of the HTTP
 * specification and the most straight-forward request / response exchange with
 * the target server. This executor does not support execution via proxy and
 * will make no attempts to retry the request in case of a redirect,
 * authentication challenge or I/O error.
 *
 * @since 4.3
 */
...
public class MinimalClientExec implements ClientExecChain {
    ...
    public MinimalClientExec(final HttpRequestExecutor requestExecutor, final HttpClientConnectionManager connManager,
        ...
        this.httpProcessor = new ImmutableHttpProcessor(new RequestContent(), new RequestTargetHost(), new RequestClientConnControl(),
